...
class Configtab(tk.Frame):
    ...
    def configwidget(self, selecttab):
        ...
        self.shiftbutton = ttk.Spinbox(self.master, text="Shift", bootstyle="PRIMARY", values= ["Morning", "Afternoon", "Night"], font=("Helvetica", 14)).grid(row=2, column=4, pady=10)
        ...
        self.blocksbutton = ttk.Spinbox(self.master, text="Blocks", bootstyle="PRIMARY", from_=1, to=6, font=("Helvetica", 14)).grid(row=4, column=4, pady=10)
        ...
        self.manualbutton = ttk.Checkbutton(self.master, text="Manual", bootstyle="warning-round-toggle").grid(row=6, column=4, pady=10)
        self.autopilotbutton = ttk.Checkbutton(self.master, text="AutoPilot", bootstyle="warning-round-toggle").grid(row=6, column=5, pady=10)
        ...
        # Navigation Button
        self.navbutton = ttk.Button(self.master, text="Gestion Activite", bootstyle="PRIMARY", command= lambda: self.selecttab(1)).grid(row=12, column=3, pady=10)
