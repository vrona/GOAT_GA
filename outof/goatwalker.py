...
def walkerMe(nofN, numRand, _randomseed, dicofdata) :
    N = nofN #5
    Nrand = numRand #1000
    ...
    #dicofdata = {"SportCo":0.17974, "Glisse":0.18476, "Chasse":0.28447, "Running":0.35094}


    wrand = Walkerrandom(dicofdata.values(), dicofdata.keys())

    from collections import defaultdict
    nrand = defaultdict(float)  # init 0
