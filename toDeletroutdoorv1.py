...
class PickGAApp(tk.Frame):
    ...
    def get_hour(self):
        ...
        self.hourlist.delete(0, tk.END)
        for row in pdb.fetch_hour():
            self.hourlist.insert(tk.END, row)
    ...
    def autoblock(self, lsofblock):
        ...
        for nblock in self.lsofblock:
            ...
            self.dictblocklist[self.lsofblock.index(nblock)] = tk.Listbox(self.master, height=1, width=5, justify="center")
    ...
    def totalpart(self):
        ...
        self.hourlist = tk.Listbox(self.master, height=1, width=25, justify="center")
        self.hourlist.grid(row=5, column=1)
        self.get_hour()
